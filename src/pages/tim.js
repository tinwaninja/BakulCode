      ...
      >
        <div className="container w-3/4 md:w-1/2 mt-20 font-serif font-hairline self-start">
          ...
          <p className="text-base">
            Tim programmer kami dapat membantu bisnismu pada setiap tahap pertumbuhannya dengan mengembangkan perangkat lunak sesuai dengan tujuan bisnismu.
          </p>
        </div>
...
export const query = graphql`
  query TeamMemberQuery {
    allMarkdownRemark(
      filter: { fileAbsolutePath: { regex: "/content/tim/" } }
